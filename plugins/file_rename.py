...
async def rename_start(client, message):
    ...
    if file.file_size > 2000 * 1024 * 1024:
         return await message.reply_text("Sorry Bro This Bot Doesn't Support Uploading Files Bigger Than 2GB, Give me money to buy premium then you can have 4GB rename bot too.", quote=True)
...
async def doc(bot, update):    
    ...
    if _bool_metadata:
        ...
        await ms.edit("⏳ Metadata Found, editing Metadata...  ⚡")
